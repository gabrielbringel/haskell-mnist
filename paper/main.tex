...
files (\texttt{train-images-idx3-ubyte}, \texttt{train-labels-idx1-ubyte},
\texttt{t10k-images-idx3-ubyte}, \texttt{t10k-labels-idx1-ubyte}) from the MNIST
archive, decompress them with \texttt{gunzip} if necessary, and place them in a
\texttt{data/} directory; the loader validates the IDX magic numbers (2051 for
