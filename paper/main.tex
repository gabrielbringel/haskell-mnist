...
\begin{table*}[t]
  ...
  \caption{The 17 QuickCheck properties. Each runs on $100$ randomized inputs
    (or $100$ cases with automatic discard). Test networks use reduced dimensions:
    $4 \to 3 \to 2$ (cf.\ \Cref{sec:res:limits}). All entries are verified
    component-by-component where applicable. Finite-difference tests use central
    differences with step $\varepsilon = 10^{-6}$; see text for tolerance formulas.}
